...
<body>
  <div class="wrapper">
    ...
    <div class="footer">
      <p>
        This gift was sent via <a href="${process.env.FRONTEND_URL ?? 'https://pensivepost.com'}">Pensive Post</a>.<br />
...
export async function sendEmail(
  ...
  const fromEmail = process.env.FROM_EMAIL ?? 'noreply@pensivepost.com';

  const mailOptions = {
    from: `"Pensive Post" <${fromEmail}>`,
    to,
    subject: `${senderName} sent you a ${brandName} gift! 🎁`,
    text:
      `Hi ${recipientName},\n\n` +
      `${senderName} sent you a ${brandName} gift card via Pensive Post.\n\n` +
